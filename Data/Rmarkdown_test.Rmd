...
```{r fig.width=10, fig.height=10, fig.cap=paste("Social network plot with keyplayers highlighted based on network statistics") }
plot(graph_complete_simpl,
     layout=layout.graph,
     rescale=T,
     edge.color="Gray80",
...
legend(x=-1.1, y = -1.1, c("Closeness","Betweenness","Degree","Eigenvector","Overlap"), pch=19,
